...
import { FileText, CheckCircle, XCircle, Settings, AlertTriangle } from "lucide-react";
          ...
          <CardContent>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              {isConfigured 
                ...
                : "Contact Flowp support to enable e-billing"
              }
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-950">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-amber-700 dark:text-amber-300">
              ...
              E-Billing Not Enabled
            </CardTitle>
            <CardDescription className="text-amber-600 dark:text-amber-400">
              Electronic billing (DIAN) has not been enabled for your account yet.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-amber-600 dark:text-amber-400">
              Please contact Flowp support to set up DIAN electronic billing for your business.
            </p>
          </CardContent>
        </Card>
      )}
