...
export default function InternalAdminDocuments() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const res = await internalAdminFetch(`/api/internal-admin/ebilling/documents?${params.toString()}`);
      return res.json();
    },
  });
  ...
  const retryMutation = useMutation({
    mutationFn: async (docId: string) => {
      return internalAdminFetch(`/api/internal-admin/ebilling/documents/${docId}/retry`, { method: "POST" });
    },
    onSuccess: () => {
