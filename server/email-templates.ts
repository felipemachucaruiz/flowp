...
const footerTranslations: Record<string, { poweredBy: string; copyright: string }> = {
  en: {
    poweredBy: "Powered by Flowp - Flowp simplifies your business operations by integrating sales, inventory, electronic invoicing, and reports in a single platform.",
    copyright: `\u00A9 ${new Date().getFullYear()} Flowp. All rights reserved.`,
  },
  es: {
    poweredBy: "Powered by Flowp - Flowp simplifica la operaci\u00F3n de tu negocio integrando ventas, inventario, facturaci\u00F3n electr\u00F3nica y reportes en una sola plataforma.",
    copyright: `\u00A9 ${new Date().getFullYear()} Flowp. Todos los derechos reservados.`,
  },
  pt: {
    poweredBy: "Powered by Flowp - Flowp simplifica a opera\u00E7\u00E3o do seu neg\u00F3cio integrando vendas, estoque, fatura\u00E7\u00E3o eletr\u00F4nica e relat\u00F3rios em uma \u00FAnica plataforma.",
    copyright: `\u00A9 ${new Date().getFullYear()} Flowp. Todos os direitos reservados.`,
  },
};
...
export function getEmailWrapper(content: string, data: EmailTemplateData = {}): string {
  ...
  const footer = footerTranslations[language] || footerTranslations.es;
...
<body>
  <div class="email-container">
    ...
    <div class="footer">
      <img class="footer-logo" alt="Flowp" src="data:image/webp;base64," />
...
export function getPasswordResetTemplate(data: PasswordResetTemplateData, language: string = "en"): { subject: string; html: string } {
  ...
  return {
    subject: t.subject,
    html: getEmailWrapper(content, { ...data, language }),
  };
}
...
export function getOrderConfirmationTemplate(data: OrderConfirmationTemplateData, language: string = "en"): { subject: string; html: string } {
  ...
  const itemsHtml = data.items.map(item => {
    ...
    return `
    <tr>
      <td style="padding: 12px 0; border-bottom: 1px solid #f4f4f5; vertical-align: middle; width: 60px;">
        <img src="${imgSrc}" alt="${item.name}" style="width: 56px; height: 56px; object-fit: cover; border-radius: 6px; border: 1px solid #e4e4e7; display: block;" />
      </td>
      <td style="padding: 12px 8px; border-bottom: 1px solid #f4f4f5; vertical-align: middle; font-size: 14px; color: #27272a;">
        ${item.name}
      </td>
      <td style="padding: 12px 8px; border-bottom: 1px solid #f4f4f5; vertical-align: middle; text-align: center; font-size: 14px; color: #52525b; white-space: nowrap;">
        x${item.quantity}
      </td>
      <td style="padding: 12px 0; border-bottom: 1px solid #f4f4f5; vertical-align: middle; text-align: right; font-size: 14px; font-weight: 600; color: #27272a; white-space: nowrap;">
        ${item.price}
      </td>
    </tr>`;
  }).join("");
